(function (e) {
    if (Modernizr.touch) {
        ...
        [].slice.call(document.querySelectorAll("ul.grid > li > figure")).forEach(function (j, h) {
            j.querySelector("figcaption > a").addEventListener("touchstart", function (i) {
                i.stopPropagation();
            }, false);
            j.addEventListener("touchstart", function (i) {
                c.toggle(this, "cs-hover");
            }, false);
        });
    }
})(window);